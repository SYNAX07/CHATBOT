...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","Twynkl")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","twinklinglights_09")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","Quantabots")
